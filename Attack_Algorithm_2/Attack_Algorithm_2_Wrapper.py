...
from Attack_Algorithm_2 import attack_algorithm_2
...
output_file_name = "Attack2_KeyLocations_" + str(num_of_rounds) + "xRounds_" + str(num_of_pairs) + "xFiles__v" + str(v_num)
...
for input_file in os.scandir(data_path):
    start_time = time.time()
    input_count += 1
    location = attack_algorithm_2(input_file.path, num_of_rounds)
