...
/****************************************************************************************
 *                                                                                      *
 *      THIS CODE IS FIXED FROM DIVIDING BY `256.0` TO DIVIDING BY `(256.0*256.0)`      *
 *                                                                                      *
 ***************************************************************************************/
...
double num_of_runs = 100;
double total_count_sum = 0;
int main(){
	...
	printf("total average is: %lf", total_count_sum/num_of_runs);
}
