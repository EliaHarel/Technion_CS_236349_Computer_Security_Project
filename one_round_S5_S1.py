...
#comparing the 4 lsb of the 2 paramaters
...
#returing the currect dicionary according to the inserted sbox value and plaintext
...
print (prob_calculation(0, 0, 0, 1))
print (prob_calculation(0, 0, 0, 5))
print (prob_calculation(4, 4, 0, 5))
print (prob_calculation(244, 4, 0, 5))
